...
///////// START ROUTES FOR PARKIR TIKET /////////
$route['parkir_tiket'] = 'notes/parkir_tiket/c_parkir_tiket';
$route['parkir_tiket/(:any)'] = 'notes/parkir_tiket/c_parkir_tiket/$1';
$route['parkir_tiket/(:any)/(:any)'] = 'notes/parkir_tiket/c_parkir_tiket/$1/$2';
$route['parkir_tiket/(:any)/(:num)/(:any)'] = 'notes/parkir_tiket/c_parkir_tiket/$1/$2/$3';
$route['parkir_tiket/(:any)/(:any)/(:any)/(:any)'] = 'notes/parkir_tiket/c_parkir_tiket/$1/$2/$3/$4';
///////// END ROUTES FOR PARKIR TIKET /////////