...
class C_laporan_rl3_11 extends MY_Controller
{
    private $param = [
        'periode_start',
        'periode_end',
    ...
    public function getRefKegiatan_get () {
        $dataRefKegiatan = $this->ref_kegiatan->getKegiatanByGroup(11);
    ...
    public function reportOneLevel_get() {
        ...
        if ($this->form_validation->run() == true) {
           ...
           if (empty($get['periode_start'])) {
            ...
            $dataOrderDetails = $this->order_dept_details->getDataOrderByGroup($get, 11);
