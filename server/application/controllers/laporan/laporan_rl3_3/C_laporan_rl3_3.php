...
class C_laporan_rl3_3 extends MY_Controller
{
    ...
    public function getRefKegiatan_get () {
        $dataRefKegiatan = $this->ref_kegiatan->getKegiatanByGroup(3);
    ...
    public function reportOneLevel_get() {
        ...
        if ($this->form_validation->run() == true) {
           ...
           if (empty($get['periode_start'])) {
            ...
            $dataOrderDetails = $this->order_dept_details->getDataOrderByGroup($get, 3);
