...
class C_global extends MY_Controller
{
    ...
    // $route['ref/blood_type'] = 'ref/c_ref/blood_type';
    {
        ...
        $res['data']    = $this->mglobal->get_blood_type();
    ...
    // $route['ref/relationship'] = 'ref/c_ref/relationship';
    {
        ...
        $res['data']    = $this->mglobal->get_relationship();
    ...
    // $route['ref/marital_status'] = 'ref/c_ref/marital_status';
    {
        ...
        $res['data']    = $this->mglobal->get_marital_status();
    ...
    // $route['ref/occupation'] = 'ref/c_ref/occupation';
    {
        ...
        $res['data']    = $this->mglobal->get_occupation();
    ...
    // $route['ref/pendidikan'] = 'ref/c_ref/pendidikan';
    {
        ...
        $res['data']    = $this->mglobal->get_pendidikan();
    ...
    // $route['ref/religion'] = 'ref/c_ref/religion';
    {
        ...
        $res['data']    = $this->mglobal->get_religion();
    ...
    // $route['ref/smoking_status'] = 'ref/c_ref/smoking_status';
    {
        ...
        $res['data']    = $this->mglobal->get_smoking_status();
    ...
    // $route['get_alamat'] = 'api/c_ref/alamat';
    {
        ...
        $result = $this->mglobal->get_by_keyword($keyword);
    ...
    {
        $id = $this->get('id');
        $result = $this->mglobal->get_rajal($id);
    ...
    // $route['get_jenis_rajal'] = 'api/c_ref/jenis_pelayanan_rawat_inap';
    {
        ...
        $id = $this->get('id');
        $result = $this->mglobal->get_ranap($id);
    ...
    // $route['get_kode_poli'] = 'api/c_ref/kode_poi';
    {
        ...
        $result = $this->mglobal->get_poli($id);
    ...
    // $route['get_dept_group'] = 'api/c_ref/departements_group';
    {
        ...
        $result = $this->mglobal->get_dept_group();
