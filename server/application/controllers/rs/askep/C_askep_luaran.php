...
class C_askep_luaran extends MY_Controller
{

	function __construct()
	{
		parent::__construct();
		$this->load->model('rs/askep/m_askep_luaran', 'askep');
	...
	public function luaran_all_get(){ 
		$get = $this->get();
        // $this->response($get,200);
        if (empty($get['id'])) {
            $id='';
	...
	public function index_post(){
		...
		$data = [
			...
			'askep_luaran_kode'       => $post['askep_luaran_kode'],
