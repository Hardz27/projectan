 ...
 *
 **********************************************************************************/
class C_notes_askep_diagnosa extends CI_Controller
{
  ...
  public function detail_diagnosa($id){
    $response_code = $this->_client_rs->request('GET', 'askep_diagnosa_all',[
      'query' => [
        'id' => $id,
      ]
    ]);
  ...
  {
    // echo count($this->input->post('/diagnosa_askep_diagnosa_kode'));
    // trace($this->input->post());
    $jlh_data = count($this->input->post('diagnosa_askep_diagnosa_kode'));
    ...
    for ($i = 0; $i < $jlh_data; $i++) {
      ...
      $params = [
        ...
        'askep_diagnosa_kode' => $this->input->post('diagnosa_askep_diagnosa_kode')[$i],
        // 'created_by' => $this->session->userdata['user_login']['id_user'],
        'json_data' => [
          'diagnosa_askep_diagnosa_nama' => $this->input->post('diagnosa_askep_diagnosa_nama')[$i],
          'diagnosa_askep_diagnosa_definisi' => $this->input->post('diagnosa_askep_diagnosa_definisi')[$i],
          'diagnosa_askep_diagnosa_kategori' => $this->input->post('diagnosa_askep_diagnosa_kategori')[$i],
          'diagnosa_askep_diagnosa_subkategori' => $this->input->post('diagnosa_askep_diagnosa_subkategori')[$i],
      ...
      try {
        ...
        $response = $this->_client_rs->request('POST', 'notes_askep_diagnosa', $this->_config);
