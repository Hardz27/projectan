 ...
 * 
 * Deskripsi
 * Menampilkan halaman client/102_pengkajian_nyeri_komprehensif
 * 
 **********************************************************************************/
class C_102_pengkajian_nyeri_komprehensif extends CI_Controller
{
  public $data;
  public function __construct()
  {
    ...
    $this->id_ref_global_tipe_42 = 102;
    ...
    $this->c_folder = "C_102_pengkajian_nyeri_komprehensif"; // <<< HANYA INI YANG PERLU DIRUBAH DI CONSTRUCT()!!!! SISANYA DIAMKAN

    //menghilangkan 'C_' pada nama class untuk dinamisasi routing;
    $this->class = str_replace("c_", "", $this->router->fetch_class());
    $this->title = 'Pengkajian Nyeri Komprehensif';
  ...
  // $route['102_pengkajian_nyeri_komprehensif'] = '102_pengkajian_nyeri_komprehensif/c_102_pengkajian_nyeri_komprehensif';
  {
    // echo base_url(); die;
  ...
  public function add_process()
  {
    ...
    $notes = [
      ...
      'desc_hubungan'                       =>  $this->input->post('desc_hubungan'),
