...
class C_144_edukasi_tindakan_anastesi extends CI_Controller
{
      ...
      foreach ($data_visit as $k => $v) {
        ...
        foreach ($data_notes as $n => $o) {
          ...
          $notes[$n] = [
            ...
            'ttl'                                 =>  $jdata['notes']['tempat_lahir'].', '.$jdata['notes']['ttl'],
  ...
  public function add_process()
  {
    ...
    $notes = [
      ...
      'tindakan_yang_dilakukan'             => !empty($this->input->post('tindakan_yang_dilakukan')) ? $this->input->post('tindakan_yang_dilakukan') : [] ,
      'tyd_ll_value'                        =>  $this->input->post('tyd_ll_value'),
      'indikasi_tindakan'                   => !empty($this->input->post('indikasi_tindakan')) ?  $this->input->post('indikasi_tindakan') : [],
      'tata_cara'                           => !empty($this->input->post('tata_cara')) ? $this->input->post('tata_cara') : [],
      'risiko_tindakan'                     => !empty( $this->input->post('risiko_tindakan')) ? $this->input->post('risiko_tindakan'): [],
      'komplikasi'                          => !empty($this->input->post('komplikasi')) ? $this->input->post('komplikasi') : [] ,
  ...
  function view_pdf($id)
  {
    ...
    $detail = [
      ...
      'nama_pasien'                         =>  $result['notes']['nama_pasien'],
      'no_mr'                               =>  $result['notes']['no_mr'],
      'ttl'                                 =>  $result['notes']['tempat_lahir'].', '. $result['notes']['ttl'],
      'tl'                                 =>   $result['notes']['ttl'],
      'ttl_wali'                            =>  $result['notes']['ttl_wali'],
      'alamat'                              =>  $result['notes']['alamat'],
      'usia'                                =>  $result['notes']['usia'],
