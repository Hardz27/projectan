 ...
 * 
 **********************************************************************************/
class C_41_edukasi_tindakan_sc extends CI_Controller
{
  public $data;
  public function __construct()
  {
    ...
    $this->c_folder = "C_41_edukasi_tindakan_sc"; // <<< HANYA INI YANG PERLU DIRUBAH DI CONSTRUCT()!!!! SISANYA DIAMKAN

    //menghilangkan 'C_' pada nama class untuk dinamisasi routing;
    $this->class = str_replace("c_", "", $this->router->fetch_class());
    $this->title = 'Edukasi Tindakan Sectio Caesarea';
