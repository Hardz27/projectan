...
class C_notes_penolakan_resusitasi extends CI_Controller
{
  ...
  public function __construct()
  {
    ...
    $this->id_ref_global_tipe_42 = 444;
  ...
  {
    $data = array(
      'title'   => 'Notes Laporan Resusitasi',
      ...
      foreach ($data_visit as $k => $v) {
        ...
        foreach ($data_notes as $n => $o) {
          ...
          $notes[$n] = [
            ...
            'penerima_informasi'  => $jdata['notes']['penerima_informasi'],
  ...
  {
    $notes = [
      'penerima_informasi'      => $this->input->post('penerima_informasi'),
  ...
  public function edit()
  {
    ...
    $detail = [
      ...
      'penerima_informasi'  => $result['notes']['penerima_informasi'],
