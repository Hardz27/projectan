...
class C_71_assesmen_bayi_baru_lahir extends CI_Controller
{
        ...
        foreach ($data_notes as $n => $o) {
          ...
          $notes[$n] = [
           ...
           'urin'                         => $jdata['notes']['urin'],
            ...
            'menit_frek_jantung'          => $jdata['notes']['menit_frek_jantung'],
            'menit_usaha_nafas'           => $jdata['notes']['menit_usaha_nafas'],
            'menit_tonus_otot'            => $jdata['notes']['menit_tonus_otot'],
            'menit_reflek'                => $jdata['notes']['menit_reflek'],
            'menit_warna_kulit'           => $jdata['notes']['menit_warna_kulit'],
  ...
  public function add_process()
  {
    $notes = [
      ...
      'menit_frek_jantung'                  =>  $this->input->post('menit_frek_jantung'),
      'menit_usaha_nafas'                   =>  $this->input->post('menit_usaha_nafas'),
      'menit_tonus_otot'                    =>  $this->input->post('menit_tonus_otot'),
      'menit_reflek'                        =>  $this->input->post('menit_reflek'),
      'menit_warna_kulit'                   =>  $this->input->post('menit_warna_kulit'),
  ...
  public function edit()
  {
    ...
    $detail = [
           ...
           'urin'                             => $result['notes']['urin'],
            ...
            'menit_frek_jantung'              => $result['notes']['menit_frek_jantung'],
            'menit_usaha_nafas'               => $result['notes']['menit_usaha_nafas'],
            'menit_tonus_otot'                => $result['notes']['menit_tonus_otot'],
            'menit_reflek'                    => $result['notes']['menit_reflek'],
            'menit_warna_kulit'               => $result['notes']['menit_warna_kulit'],            
