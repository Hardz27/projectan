 ...
 * 
 **********************************************************************************/
class C_docs_pasien_tb_anak extends CI_Controller
{
  public $data;
  public function __construct()
  {
    ...
    $this->id_ref_global_tipe_42 = 772;
    ...
    $this->c_folder = "C_docs_pasien_tb_anak"; // <<< HANYA INI YANG PERLU DIRUBAH DI CONSTRUCT()!!!! SISANYA DIAMKAN
      ...
      foreach ($data_visit as $k => $v) {
        ...
        foreach ($data_notes as $n => $o) {
          ...
          $notes[$n] = [
            ...
            'jam'                                 => $jdata['notes']['jam'],
            'kontak_tb'                           => $jdata['notes']['kontak_tb'],
            'uji_tuberkulin'                      => $jdata['notes']['uji_tuberkulin'],
            'bb_keadaan_gizi'                     => $jdata['notes']['bb_keadaan_gizi'],
            'demam'                               => $jdata['notes']['demam'],
            'batuk_kronik'                        => $jdata['notes']['batuk_kronik'],
            'pembesaran_kelenjar'                 => $jdata['notes']['pembesaran_kelenjar'],
            'pembengkakan_sendi'                  => $jdata['notes']['pembengkakan_sendi'],
            'foto_toraks'                         => $jdata['notes']['foto_toraks'],
  ...
  public function add_process()
  {
    $notes = [
      ...
      'kontak_tb'                             =>  $this->input->post('kontak_tb'),
      'uji_tuberkulin'                        =>  $this->input->post('uji_tuberkulin'),
      'bb_keadaan_gizi'                       =>  $this->input->post('bb_keadaan_gizi'),
      'demam'                                 =>  $this->input->post('demam'),
      'batuk_kronik'                          =>  $this->input->post('batuk_kronik'),
      'pembesaran_kelenjar'                   =>  $this->input->post('pembesaran_kelenjar'),
      'pembengkakan_sendi'                    =>  $this->input->post('pembengkakan_sendi'),
  ...
  public function edit()
  {
    ...
    $detail = [
      ...
      'kontak_tb'                           => $result['notes']['kontak_tb'],
      'uji_tuberkulin'                      => $result['notes']['uji_tuberkulin'],
      'bb_keadaan_gizi'                     => $result['notes']['bb_keadaan_gizi'],
      'demam'                               => $result['notes']['demam'],
      'batuk_kronik'                        => $result['notes']['batuk_kronik'],
      'pembesaran_kelenjar'                 => $result['notes']['pembesaran_kelenjar'],
      'pembengkakan_sendi'                  => $result['notes']['pembengkakan_sendi'],
      'foto_toraks'                         => $result['notes']['foto_toraks'],
