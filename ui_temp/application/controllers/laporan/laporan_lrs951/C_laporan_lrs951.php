...
class C_laporan_lrs951 extends CI_Controller {
  ...
  function _getvalue() {
    ...
    $request_value = $this->_laporan->request('GET', (!empty($this->input->get('tgl_start1')) && !empty($this->input->get('tgl_end2'))?'laporan_rekap/lrs951':'laporan_rekap/ref/lrs951'), [
      'query' => [
      	'tipe_laporan' => '0',
        'jenis_periode' => '0',
