...
<body style="margin:0px;">
  ...
  <div class="row" style="margin-bottom:0px;">
    ...
    <?php $no = 0; ?>
    <div class="row-panel">
      <div class="row-heading border-blue bg-blue font-white font-size-9 r-bold">Data Skrinning TB</div>
        <div class="row-body">

          <table width="100%" cellspacing="0">
          <tr>
            <td class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-head">No</td>
            <td class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-head"  colspan="5">Gejala dan Tanda TB</td>
            <td width="10%" class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-head">Ya</td>
            <td width="10%" class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-head">Tidak</td>
            
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Batuk Berdahak Selama > 2-3 Minggu</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container ">
                <input type="radio" name="batuk_berdahak" <?= $list['notes']['batuk_berdahak'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container" >
                <input type="radio" name="batuk_berdahak" <?= $list['notes']['batuk_berdahak'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Batuk Berdarah</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="batuk_berdarah" <?= $list['notes']['batuk_berdarah'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="batuk_berdarah" <?= $list['notes']['batuk_berdarah'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Demam Hilang Timbul > 1 Bulan</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="demam" <?= $list['notes']['demam'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="demam" <?= $list['notes']['demam'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Keringat Malam Tanpa Aktifitas</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="keringat_malam" <?= $list['notes']['keringat_malam'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="keringat_malam" <?= $list['notes']['keringat_malam'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Penurunan Berat Badan Tanpa Penyebab yang Jelas</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="penurunan_bb" <?= $list['notes']['penurunan_bb'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="penurunan_bb" <?= $list['notes']['penurunan_bb'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Pembesaran Kelenjar Getah Bening (benjolan didaerah leher) Dengan Ukuran > 2cm</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="pembesaran_kelenjar" <?= $list['notes']['pembesaran_kelenjar'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="pembesaran_kelenjar" <?= $list['notes']['pembesaran_kelenjar'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Sesak Nafas dan Nyeri Dada</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="sesak_nafas" <?= $list['notes']['sesak_nafas'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="sesak_nafas" <?= $list['notes']['sesak_nafas'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Pernah Minum Obat Paru Dalam Waktu Lama Sebelumnya</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="pernah_minum_obat_paru" <?= $list['notes']['pernah_minum_obat_paru'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="pernah_minum_obat_paru" <?= $list['notes']['pernah_minum_obat_paru'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5">Ada Keluarga / Tetangga yang Pernah Sakit Paru-paru / TB / Pengobatan Paru Lama</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1"> 
              <label class="container">
                <input type="radio" name="ada_keluarga_sakit_paru" <?= $list['notes']['ada_keluarga_sakit_paru'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1">
              <label class="container">
                <input type="radio" name="ada_keluarga_sakit_paru" <?= $list['notes']['ada_keluarga_sakit_paru'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
          <tr>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1 border-left-1" rowspan="3"><?= ++$no; ?>.</td>
            <td class="font-size-8 centerp-row border-bottom-1 border-right-1" colspan="5" rowspan="3">Penyakit Lain : <br>- Hipertensi<br>- DM</td>
            <td class="font-size-8 centerp-head border-bottom-1 border-right-1" rowspan="3"> 
              <label class="container">
                <input type="radio" name="penyakit_lain" <?= $list['notes']['penyakit_lain'] == 'ya' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
            <td class="font-size-8 centerp-head border-right-1 border-bottom-1" rowspan="3">
              <label class="container">
                <input type="radio" name="penyakit_lain" <?= $list['notes']['penyakit_lain'] == 'tidak' ? 'checked="checked"' : ''; ?> >
                <span class="checkmark"></span>
              </label>
            </td>
          </tr>
        ...
        <ul style="list-style-type:disc">
            <li class="font-size-10">- Bila jawaban "Ya" salah satu pertanyaan diatas : segera untuk pemeriksaan dahak secara mikroskopis atau pemeriksaan penunjang untuk penegakan diagnosis TB kalau sarana pemeriksaan untuk pencegahan diagnosis TB tidak tersedia diunit layanan</li>
            <li class="font-size-10">- Bila jawaban "Tidak" pada semua pertanyaan diatas, ulangi pertanyaan diatas pada kunjungan berikutnya </li>
        </ul>
        <br>
