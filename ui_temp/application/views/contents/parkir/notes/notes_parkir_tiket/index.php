  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-2">
        ...
        <div class="row">
          <div class="col-md-12">
            <button style="margin:2px" data-id="1" id="is-exit-aktif" class="btn btn-sm btn-default btn-primary is-exit">Aktif</button>
            <button style="margin:2px" data-id="0" id="is-exit-arsip" class="btn btn-sm btn-default is-exit">Arsip</button>
          </div>
        </div>
      </div>
      <div class="col-md-2">
