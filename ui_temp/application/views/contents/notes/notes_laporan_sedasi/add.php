              ...
              <div class="row">
                <div class="col-md-12"> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <textarea class="form-control input-sm" name="diagnosis" id="diagnosis" value="" required></textarea> 
                    </div>
                  </div>
                  <br>
...
<script type="text/javascript">
  ...
  $('.btn-batal-<?= $this->router->fetch_class(); ?>').click(function (e)
  {
   ...
   $('#form-add-1-<?= $this->router->fetch_class(); ?>').submit(function(e) {
    ...
    var jamMulai = $('#jam').val();
    var jamAkhir = $('#jam_akhir').val();
    console.log(jamMulai, jamAkhir)
...
function dataError() {
    ...
    alert('Gagal menyimpan data! harap cek Jam mulai dan berakhir!');
    $('.btn-kirim-<?= $this->router->fetch_class(); ?>').removeAttr('disabled');
    $('.btn-kirim-<?= $this->router->fetch_class(); ?>').removeAttr('disabled');
