            ...
            <div class="row">
              <div class="col-md-4">
                <table class="table nowrap">
                  <tbody>
                    ...
                    <tr>
                      <td>Ruang Rawat</td>
                      <td class="with-ellipsis"><?= $k['ruang_rawat']; ?></td>
                    </tr>
                    <tr>
                      <td>Tanggal Lahir</td>
              ...
              <div class="col-md-4">
                <table class="table nowrap">
                  <tbody>
                    <tr>
                      <td>Fungsi Kognitif</td>
                      <td class="with-ellipsis"><?= $k['fungsi_kognitif']; ?></td>
                    </tr>
                    <tr>
                      <td>Pasien Dengan Risiko Tinggi</td>
                      <td class="with-ellipsis"><?= $k['pasien_risiko_tinggi']; ?></td>
                    </tr>
                    <tr>
                      <td>Potensi Complain</td>
                      <td class="with-ellipsis"><?= $k['potensi_complain']; ?></td>
                    </tr>
                    <tr>
                      <td>Riwayat Sakit Kronis</td>
                      <td class="with-ellipsis"><?= $k['riwayat_sakit_kronis']; ?></td>
                    </tr>
                    <tr>
                      <td>Status Fungsional Rendah</td>
                      <td class="with-ellipsis"><?= $k['status_fungsional_rendah']; ?></td>
                    </tr>
                    <tr>
                      <td>Riwayat alat medis di masa lalu</td>
                      <td class="with-ellipsis"><?= $k['riwayat_alat_medis']; ?></td>
                    </tr>
                    <tr>
                      <td>Riwayat Gangguan Mental</td>
                      <td class="with-ellipsis"><?= $k['riwayat_gangguan_mental']; ?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="col-md-4">
                <table class="table nowrap">
                  <tbody>
                    <tr>
                      <td>Readmisi > 3x dalam 6 bulan</td>
                      <td class="with-ellipsis"><?= $k['readmisi']; ?></td>
                    </tr>
                    <tr>
                      <td>Perkiraan Biaya Tinggi</td>
                      <td class="with-ellipsis"><?= $k['perkiraan_biaya_tinggi']; ?></td>
                    </tr>
                    <tr>
                      <td>Sistem Biaya</td>
                      <td class="with-ellipsis"><?= $k['sistem_biaya']; ?></td>
                    </tr>
                    <tr>
                      <td>Lama Dirawat</td>
                      <td class="with-ellipsis"><?= $k['lama_dirawat']; ?></td>
                    </tr>
                    <tr>
                      <td>Risiko Komplikasi berat di rumah</td>
                      <td class="with-ellipsis"><?= $k['risiko_komplikasi_berat_di_rumah']; ?></td>
                    </tr>
                    <!-- <tr>
