      ...
      <div class="row-heading border-blue bg-blue font-white font-size-9 r-bold">Data <?= $title; ?></div>
        <div class="row-body">
          ...
          <tr>
            ...
            <td class="font-size-8 border-bottom-1 border-right-0 centerp-row">:<?= $list['notes']['usia']; ?> &nbsp; th &nbsp;&nbsp;&nbsp;</td>
        ...
        <table width="100%" cellspacing="0">
          <tr>
            <td width="30%" class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-0 centerp-head" > Jenis Informasi</td>
            <td width="70%" class="r-bold font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-head" > Isi Informasi</td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Diagnosis (WD dan DD)</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['diagnosis']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Dasar Diagnosis</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" >Anamnesis, pemeriksaan fisik, pemeriksaan penunjang</td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Jenis Tindakan</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['tindakan_yang_dilakukan']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Indikasi Tindakan</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['indikasi_tindakan']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Tata Cara</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['tata_cara']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Tujuan</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['tujuan']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Resiko/Komplikasi</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['resiko_komplikasi']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Prognosis</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['prognosis']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Alternatif</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['alternatif']; ?></td>
          </tr>
          <tr>
            <td width="30%" class=" font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left" > Lain-lain/Kebutuhan darah</td>
            <td width="70%" class="font-size-8 border-bottom-1 border-right-1 centerp-row" ><?= $list['notes']['lain_lain']; ?></td>
          </tr>
          <tr>
            <td width="30%" class="font-size-8 border-bottom-1 border-left-1 border-right-1 centerp-left"></td>
            <td width="70" class="font-size-8 border-bottom-1 border-left-0 border-right-1 centerp-left">
              <table width="100%" cellspacing="0">
                <tr>
              ...
              <table width="100%" cellspacing="0">
                    <tr>
                      <td class="text-center font-size-8">
                        ...
                        <center>
                          <img src="<?= $list['notes']['coretan_wali']; ?>" alt="" height="75px" width="250px">
                        </center>
                        <div><?= $list['notes']['nama_wali']; ?></div>
                      </td>
                      <td class="text-center font-size-8"> 
                        <div class="r-bold">Pasien</div>
                        <center>
                          <img src="<?= $list['notes']['coretan_pasien']; ?>" alt="" height="75px" width="250px">
                        </center>
                          <div>
              ...
              <table width="100%" cellspacing="0">
                    <tr>
                      <td class="text-center font-size-8" width="50%">
                        ...
                        <center>
                          <img src="<?= $list['notes']['coretan_saksi']; ?>" alt="" height="75px" width="250px">
                        </center>
                          <div>
                            <?php echo ucwords(strtolower($list['notes']['nama_saksi_rs'])); ?> 
                          </div>
                      </td>
                      <td class="text-center font-size-8">
          ...
          <table width="100%" cellspacing="0" >
            <tr>
              <td class="r-bold font-size-8 border-bottom-0 border-left-1 border-right-1 text-center" style="padding: 10px;"> 
                <br>
                <center>PERSETUJUAN TINDAKAN INVASIF, BEDAH, ATAU TINDAKAN BERISIKO TINGGI</center>
              </td>
            </tr>
        </table>
        <table width="100%" cellspacing="0">
            ...
            <td width="50%" class="border-left-1" style="padding: 10px;">
              ...
              <table width="100%" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class="font-size-8">: <?=$list['notes']['tanggal_lahir_tindakan'];?></td>
                </tr>
                <tr>
                  <td width="40%" class="font-size-8 ">Alamat</td>
                  <td class="font-size-8">: <?=$list['notes']['alamat_tindakan'];?></td>
                </tr>
                <tr>
        ...
        <table width="100%" cellspacing="0">
          <tr>
            <td class="border-left-1 border-right-1 font-size-8" style="padding: 10px;">
              <br>
             Bertindak selaku <span class="r-bold"><?=$list['notes']['hubungan'];?></span> dan penanggung jawab atau wali atas pasien, menyatakan <b>SETUJU</b> untuk dilakukan tindakan berupa <b><b>INVASIF BEDAH ATAU TINDAKAN BERISIKO TINGGI</b></b> terhadap :
            </td>
          </tr>
        </table>
        <table width="100%" cellspacing="0">
          <tr>
            ...
            <td class="border-right-1">
              <table width="100%" cellspacing="0">
                <tr>
                  <td width="40%" class="font-size-8">Jenis Kelamin</td>
                  <td class="font-size-8">: <?=$list['notes']['jenis_kelamin'];?></td>
                </tr>
                <tr>
                  <td width="40%" class="font-size-8">Usia</td>
        ...
        <table width="100%" cellspacing="0">
          <tr>
            <td class="border-left-1 border-right-1 font-size-8" style="padding: 10px; text-align: justify;">
              <br>
              <p>
                Saya menyatakan bahwa sesungguhnya dan tanpa paksaan bahwa :
              </p>
              <ol type="number">
                <li>Saya telah menerima informasi jenis tindakan yang akan dilakukan.</li>
                <li>Saya mengerti bahwa tindakan tersebut mengandung beberapa resiko, termasuk perubahan tekanan darah, resiko obat (alergi), henti jantung, kerusakan otak, kelumpuhan, kerusakan syarat serta komplikasi lain yang juga mungkin terjadi bahkan kematian.
                </li>
                <li>
                  Saya telah menerima penjelasan secara teliti tentang tindakan yang akan dilakukan, mengerti dan menyetujui penjelasan tentang tindakan yang akan dilakukan termasuk kemungkinan komplikasi yang mungkin terjadi serta kelebihan atau kelemahan dari setiap jenis tindakan yang dilakukan.
                </li>
                <li>
                  Saya mempunyai kewajiban untuk memberi informasi kepada dokter mengenai semua penyakit dan obat yang pasien minum, seperti aspirin, pengencer darah, kontrasepsi, obat flu, narkotik, marijuana, kokain, dan lain-lain.
                </li>
                <li>
                  Saya bersedia menanggung tindakan kedokteran, kecuali terhadap pihak lain yang menyatakan bertanggung jawab secara finansial terhadap tindakan ini.
                </li>
              </ol>
              <p>
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan hal-hal tersebut diatas, saya enjamin sepenuhnya bahwa tindakan saya untuk menyetujui tindakan medik diatas adalah untuk mewakili kepentingan saya / pasien dan keluarga pasien, dan saya bertanggung jawab sepenuhnya apabila terhadap pihak lain yang mengajukan keberatan atas persetujuan ini.
              </p>
              <p>
                <br>
