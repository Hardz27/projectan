                            ...
                            <div class="row">
                              <div class="col-md-12"> 
                                <div class="row">
                                  ...
                                  <div class="col-md-6 text-center" style="margin: 20px 0px 20px 0px;"> 
                                    <input style="width: 80%" type="text" name="nama_wali_ttd" class="form-control" placeholder="Wali"  required autocomplete="off">
                                  </div>
                                  <div class="col-md-6 text-center" style="margin: 20px 0px 20px 0px;"> 
                                    <input style="width: 80%" type="text" name="nama_pasien_ttd" class="form-control" placeholder="Pasien"  required autocomplete="off">
                                  </div>
                                  <br><br>
