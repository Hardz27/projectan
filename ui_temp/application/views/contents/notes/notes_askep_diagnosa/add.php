                   ...
                   <div class="col-md-10">
                          <select name="askep_diagnosa" id="askep_diagnosa" style="width: 100%">
                            ...
                            <?php foreach ($data_askep_diagnosa as $v){?>
                              <option value="<?= $v['id_ref_askep_diagnosa'] ?>">
...
<script type="text/javascript">
  ...
  $('.btn-add').click(function(e) {
    ...
    var as_diagnosa = $("#askep_diagnosa").val();

    $.ajax({
      type :'get',
      url:'<?php echo base_url(); ?>' + class_name + "/detail_diagnosa/" + as_diagnosa,
      dataType:'json',
      success : function(data){  
        var newRow = `<tr>
                    <input type="hidden" name="diagnosa_askep_diagnosa_kode[]" value="` + data.askep_diagnosa_kode + `">
                    <input type="hidden" name="diagnosa_askep_diagnosa_nama[]" value="` + data.askep_diagnosa_nama + `">
                    <input type="hidden" name="diagnosa_askep_diagnosa_definisi[]" value="` + data.askep_diagnosa_definisi + `">
                    <input type="hidden" name="diagnosa_askep_diagnosa_kategori[]" value="` + data.askep_diagnosa_kategori + `">
                    <input type="hidden" name="diagnosa_askep_diagnosa_subkategori[]" value="` + data.askep_diagnosa_subkategori + `">
                    <td><span class="sn"></span>
                    <td><button type="button" class="btn btn-sm btn-danger hapus">Hapus</button></td>
                    <td>` + data.askep_diagnosa_kode + ` | ` + data.askep_diagnosa_nama + `</td>
                  </tr>`
          ...
          $("#askep_diagnosa").val('').trigger('change');
        }
    });
