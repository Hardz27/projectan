      ...
      <div class="row-heading border-blue bg-blue font-white font-size-9 r-bold">Data Penolakan Resusitasi</div>
        ...
        <table width="100%" cellspacing="0">
         ...
         <tr>
            ...
            <td width="50%" style="text-align: center;" class="detail-administration r-bold font-size-8 pl-5 pt-2 pr-2 pb-4 border-left-1 border-right-1 border-bottom-1">
              Penerima Informasi<br>
              <!-- <img width="100px" src="<?php echo $list['notes']['digital_signature_approved_petugas'];?>"> -->
              <br><br><br><br><br><br>
              <?php echo $list['notes']['penerima_informasi']; ?><br>
              <!-- Tanda tangan dan Nama jelas<br> -->
            </td>
          </tr>
